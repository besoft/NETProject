...
{
	/// <summary>
	/// This collection represents a dynamic collection of evaluations belonging to one particular category (referenced as parent).
	/// </summary>
	public class EvaluationObservableCollectionWithParentCategory : ObservableCollectionWithParentReference<Evaluation, Category>
	{
		/// <summary>
		...
		public EvaluationObservableCollectionWithParentCategory(Category parent, string TPropertyNameWithReferenceToParent = null)
		...
		public EvaluationObservableCollectionWithParentCategory(Category parent, string TPropertyNameWithReferenceToParent,
			IEnumerable<Evaluation> collection)
			: base(parent, TPropertyNameWithReferenceToParent, collection)
		{
			Contract.Requires(parent != null);
		}
