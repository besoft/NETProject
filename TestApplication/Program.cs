...
namespace TestApplication
{
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            repo.Students[0].Evaluation[0].Points = 5.5m;
            repo.Students[0].Evaluation[0].Reason = "Bad design";

            repo.Students[0].Evaluation[1].Points = 4m;
            repo.Students[0].Evaluation[1].Reason = "Bad implementation";

            repo.Students[0].Evaluation[2].Points = 2m;

            repo.Students[1].Evaluation[0].Points = 15m;

            //zmena schema
            repo.Students[2].EvaluationSchema = new Zcu.StudentEvaluator.Core.Data.Schema.EvaluationItemSchema[2];
